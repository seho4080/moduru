...
const mapSlice = createSlice({
  ...
  reducers: {
    /**
     * 핀 추가
     * @param {import('immer').Draft<State>} state - 현재 상태
     * @param {import('@reduxjs/toolkit').PayloadAction<{ id: string, lat: number, lng: number }>} action - 추가할 핀 정보
     */
    addPin: (state, action) => {
     ...
     * 핀 삭제
     * @param {import('immer').Draft<State>} state - 현재 상태
     * @param {import('@reduxjs/toolkit').PayloadAction<string>} action - 삭제할 핀의 ID
     */
