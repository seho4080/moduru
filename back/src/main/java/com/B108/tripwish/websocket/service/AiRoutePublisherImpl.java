...
public class AiRoutePublisherImpl implements AiRoutePublisher {
  ...
  public void started(Long roomId, String jobId, int days) {
    ...
    log.info(
        "[AI-ROUTE][PUBLISH] STARTED → roomId={}, jobId={}, days={}, frontPayload={}",
        roomId,
        jobId,
        days,
        front);
  ...
  public void progress(Long roomId, String jobId, int progress) {
    ...
    Map<String, Object> front = toFrontStatusPayload(m);
    log.info(
        "[AI-ROUTE][PUBLISH] PROGRESS → roomId={}, jobId={}, progress={}, frontPayload={}",
        roomId,
        jobId,
        progress,
        front);
  ...
  public void done(Long roomId, String jobId, AiRecommendBroadcastDto result) {
    ...
    log.info(
        "[AI-ROUTE][PUBLISH] DONE(status) → roomId={}, jobId={}, frontPayload={}",
        roomId,
        jobId,
        frontStatus);
    ...
    m.put("result", result);
    log.info(
        "[AI-ROUTE][PUBLISH] RESULT(data) → roomId={}, jobId={}, payload={}", roomId, jobId, m);
  ...
  public void error(Long roomId, String jobId, String message) {
    ...
    Map<String, Object> front = toFrontStatusPayload(m);
    log.info(
        "[AI-ROUTE][PUBLISH] ERROR → roomId={}, jobId={}, message={}, frontPayload={}",
        roomId,
        jobId,
        message,
        front);
  ...
  public void invalidated(Long roomId, String reason) {
    ...
    Map<String, Object> front = toFrontStatusPayload(m);
    log.info(
        "[AI-ROUTE][PUBLISH] INVALIDATED → roomId={}, reason={}, frontPayload={}",
        roomId,
        reason,
        front);
    redisPublisher.publish(RedisChannelType.AI_ROUTE_STATUS, front);
