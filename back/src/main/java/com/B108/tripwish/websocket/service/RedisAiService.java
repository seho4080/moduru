...
public class RedisAiService {
    ...
    public void saveStarted(AiTaskType t, Long roomId, String jobId, int days, Map<String, Object> base) {
        try {
    ...
    public void saveProgressThrottled(AiTaskType t, Long roomId, String jobId, int progress, Map<String, Object> base) {
        try {
    ...
    public void saveDone(AiTaskType t, Long roomId, String jobId, Object resultDto, Map<String, Object> base) {
        try {
            Map<String, Object> status = new HashMap<>(base);
    ...
    public void saveError(AiTaskType t, Long roomId, String jobId, String message, Map<String, Object> base) {
        try {
            Map<String, Object> status = new HashMap<>(base);
    ...
    public void saveProgressThrottled(Long roomId, String jobId, int progress, Map<String, Object> base) {
