...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtToken login(String email, String password) {
        ...
        userTokenRepository.save(UserToken.builder().user(user).refreshToken(jwtToken.getRefreshToken())
                .issuedAt(LocalDateTime.now()).expiresAt(jwtToken.getRefreshTokenExpiresAt()).build());
    ...
    public JwtToken reissue(String refreshToken) {
        ...
        Authentication authentication = new UsernamePasswordAuthenticationToken(token.getUser().getEmail(), null,
                authorities);
