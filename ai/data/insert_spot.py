...
DATA_PATH = os.path.join(BASE_DIR, "spot_data_embedding.json")
...
for item in data:
    ...
    cur.execute(
        ...
        RETURNING id
        """,
        (2, kakao_id, name, place_url, address_name, road_address_name, lng, lat, embedding),
    )
    place_id = cur.fetchone()[0]

    # 이미지 삽입
    for img_url in item.get("images", []):
        cur.execute("INSERT INTO place_metadata_images (place_id, img_url) VALUES (%s, %s)", (place_id, img_url))
